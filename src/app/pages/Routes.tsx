  ...
  const routes = useMemo<RouteData[]>(() => realRoutes || [
    {
      ...
      steps: [
        { instruction: t("routes.goStraight", language), distance: "450m", icon: "straight", street: "R. Laurentino Braz" },
        { instruction: t("routes.turnRight", language), distance: "800m", icon: "right", street: "Av. Noel Nutels" },
        { instruction: t("routes.turnLeft", language), distance: "1.2km", icon: "left", street: "Av. Brasil", warning: t("routes.warnWellLit", language) },
        { instruction: t("routes.goStraight", language), distance: "500m", icon: "straight", street: "R. Recife" },
        { instruction: t("routes.turnRight", language), distance: "250m", icon: "right", street: "Av. Desembargador João Machado" },
        { instruction: t("routes.arrivedDest", language), distance: "—", icon: "arrive", street: destination || "Destino" },
      ],
    },
    {
      ...
      steps: [
        { instruction: t("routes.goStraight", language), distance: "300m", icon: "straight", street: "R. Laurentino Braz" },
        { instruction: t("routes.turnLeft", language), distance: "600m", icon: "left", street: "Av. das Torres", warning: t("routes.warnHeavyTraffic", language) },
        { instruction: t("routes.turnRight", language), distance: "900m", icon: "right", street: "Av. Autaz Mirim", warning: t("routes.warnSuspicious", language) },
        { instruction: t("routes.goStraight", language), distance: "600m", icon: "straight", street: "R. São Luís" },
        { instruction: t("routes.turnRight", language), distance: "400m", icon: "right", street: "R. Recife" },
        { instruction: t("routes.arrivedDest", language), distance: "—", icon: "arrive", street: destination || "Destino" },
      ],
    },
    {
      ...
      steps: [
        { instruction: t("routes.goStraight", language), distance: "200m", icon: "straight", street: "R. Laurentino Braz" },
        { instruction: t("routes.turnLeft", language), distance: "500m", icon: "left", street: "Travessa Local", warning: t("routes.warnPoorLighting", language) },
        { instruction: t("routes.turnRight", language), distance: "700m", icon: "right", street: "R. Beco da Feira", warning: t("routes.warnHighCrime", language) },
        { instruction: t("routes.goStraight", language), distance: "500m", icon: "straight", street: "Av. Autaz Mirim", warning: t("routes.warnFlooding", language) },
        { instruction: t("routes.turnLeft", language), distance: "400m", icon: "left", street: "R. São Luís", warning: t("routes.warnDamagedSidewalk", language) },
        { instruction: t("routes.arrivedDest", language), distance: "—", icon: "arrive", street: destination || "Destino" },
      ],
    },
